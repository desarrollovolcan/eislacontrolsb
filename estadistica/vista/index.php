...
if ($PRODUCTORESASOCIADOS) {
    ...
    $KILOSRECEPCIONACUMULADOS = $CONSULTA_ADO->kilosMateriaPrimaIndustrialProductorPorEmpresa($TEMPORADAS, $ESPECIE, $ARRAYEMPRESAPRODUCTOR);
    $KILOSRECEPCIONHOY = $CONSULTA_ADO->kilosRecepcionadosHoyIndustrialProductorPorEmpresa($TEMPORADAS, $ESPECIE, $ARRAYEMPRESAPRODUCTOR);
