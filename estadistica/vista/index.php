...
if ($PRODUCTORESASOCIADOS) {
    ...
    $KILOSRECEPCIONACUMULADOS = $CONSULTA_ADO->kilosMateriaPrimaIndustrialProductor($TEMPORADAS, $ESPECIE, $PRODUCTORESASOCIADOS);
    $KILOSRECEPCIONHOY = $CONSULTA_ADO->kilosRecepcionadosHoyIndustrialProductor($TEMPORADAS, $ESPECIE, $PRODUCTORESASOCIADOS);
